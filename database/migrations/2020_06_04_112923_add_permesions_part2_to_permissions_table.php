        ...
        Schema::table('permissions', function (Blueprint $table) {
            \Illuminate\Support\Facades\DB::table('permissions')->insert(
                array(
                    ...
                    ['id' => '94', 'name' => 'إدارة  المستودعات', 'ar_name' => '-', 'guard_name' => 'web'],
                    [ 'id' => '95', 'name' => 'إدارة تصنيفات الاقسام', 'ar_name' => '-', 'guard_name'=>'web'],
                    [ 'id' => '96', 'name' => 'إدارة  الضرائب', 'ar_name' => '-', 'guard_name'=>'web'],
                    ['id' => '97', 'name' => 'إدارة الاصناف', 'ar_name' => '-', 'guard_name' => 'web'],
                    ['id' => '98', 'name' => 'إدارة  ارفف الاصناف', 'ar_name' => '-', 'guard_name' => 'web'],
                    ...
                    ['id' => '103', 'name' => 'تقارير المستودعات ', 'ar_name' => '-', 'guard_name' => 'web'],
