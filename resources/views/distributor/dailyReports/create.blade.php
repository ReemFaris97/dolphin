        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    {!! Form::open(['method'=>'post','route'=>'distributor.dailyReports.store','files'=>'true','class'=>'clearfix m-form m-form--fit m-form--label-align-right'])!!}
                    @include('distributor.dailyReports._form')
