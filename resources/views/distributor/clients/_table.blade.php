...
<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_1">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{!!route('distributor.clients.show',$client->id)!!}" class="btn btn-warning"> <i
                        class="fas fa-book"></i> تفاصيل</a>
                <a href="{!!route('distributor.clients.edit',$client->id)!!}" class="btn btn-primary"> <i
                        class="fas fa-pen"></i> تعديل</a>
                <a href="#" onclick="Delete({{$client->id}})" data-original-title="حذف"
                    class="btn btn-danger btn-circle"><i class="fa fa-trash"></i> حذف</a>
                {!!Form::open( ['route' => ['distributor.clients.destroy',$client->id] ,'id'=>'delete-form'.$client->id,
                'method' => 'Delete']) !!}
                {!!Form::close() !!}
            </td>
