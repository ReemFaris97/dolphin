...
@section('title') تأكيد ايداع {!!$bank_deposit->deposit->number!!}
@endsection
...
@section('breadcrumb')
@php($breadcrumbs=['ايداعات العملاء'=>route('distributor.bank-deposits.index'),'تأكيد'=>route('distributor.bank-deposits.edit',$bank_deposit->id)])
