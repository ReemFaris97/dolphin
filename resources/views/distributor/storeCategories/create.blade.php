        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="m-portlet m-portlet--tab">
                    ...
                    {!! Form::open(['method'=>'post','route'=>'distributor.store_categories.store','files'=>'true','class'=>'clearfix m-form m-form--fit m-form--label-align-right'])!!}
