...
-->
						...
						<tfoot class="tempDisabled">
							...
							<tr><th colspan="9"><button type="submit">حفظ</button></th></tr>
						</tfoot>
					</table>
...
//		Getting Date and time code
		...
		var dateInpt = expirationDate == 1 ? '<input type="date" class="expiration form-control" name="expire_date" value="' + today + '" , min="' + today + '">' : '---' ;
