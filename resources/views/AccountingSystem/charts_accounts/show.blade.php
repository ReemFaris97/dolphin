    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">عرض {{ $account->ar_name }}
                <a href="{{ route('accounting.ChartsAccounts.edit', $account->id) }}" data-toggle="tooltip"
                    data-original-title="تعديل" class="btn btn-warning"> <i class="icon-pencil7 text-inverse"
                        style="margin-left: 10px"></i> </a>

                <a href="#" onclick="Delete({{ $account->id }})" data-toggle="tooltip" data-original-title="حذف"
                    class="btn btn-danger"> <i class="icon-trash text-inverse "></i></a>
                ...
                <div role="tabpanel" id="menu4" class=" tab-pane active">
                    ...
                    @if ($account->kind == 'sub')
                        <div class="form-group col-sm-6 col-xs-12 pull-left">
                            ...
                            <input type="text" name="amount" class="form-control" value="{{ $account->amount }}"
                                disabled>
                        </div>
                    @else
                        <div class="form-group col-sm-6 col-xs-12 pull-left">
                    ...
                    <div class="form-group col-sm-6 col-xs-12 pull-left">
                        ...
                        <input type="text" name="openning_balance" class="form-control"
                            value="{{ $account->openning_balance }}" disabled>
                    </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post"
                                            action="{{ route('accounting.custodies.add_amount', $custody->id) }}"
                                            id="form1">
                                            @csrf
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary"
                                            onclick="document.getElementById('form1').submit()">اضافه العهدة</button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post"
                                            action="{{ route('accounting.custodies.decreased_amount', $custody->id) }}"
                                            id="form2">
                                            @csrf
                                            <label style="color:black"> المبلغ</label>
                                            <input type="text" name="amount" class="form-control">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">اغلاق</button>
                                        <button type="submit" class="btn btn-primary"
                                            onclick="document.getElementById('form2').submit()">تخفيض</button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            function Delete(id) {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        swal("تم االإلفاء", "حذف  الحساب  تم الغاؤه", 'info', {
                            buttons: 'موافق'
                        });
                    }
                });
