                ...
                @foreach($purchases as $row)
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{route('accounting.purchases.edit',['id'=>$row->id])}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-pencil7 text-inverse" style="margin-left: 10px"></i> </a>
