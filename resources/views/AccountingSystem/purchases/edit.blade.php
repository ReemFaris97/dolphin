...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">  تعديل فاتوره مشتريات
						...
						<tbody>
                            ...
                            <tr class="single-row-wrapper" id="row{{++$key}}" data-ifhastax="${priceHasTax}" data-tot-taxes="${totalTaxes}">
                                ...
                                <td class="product-quantity maybe-hidden quantity_enable" width="70">
                                    <input type="number" placeholder="الكمية" step="1" min="1"  value="{{$row->quantity}}" id="sale" class="form-control" name="quantity_old[{{$row->product_id}}]">
                                </td>
                                <td class="expiration-date maybe-hidden expiration_enable" width="120">
                                    <input type="date" class="expiration form-control" name="expire_date_old"  value="{{$row->expire_date}}">
                                </td>
                                ...
                                <td class="single-price-before maybe-hidden">
                                    <input type="number" class="form-control" step="any" value="{{round($row->price,3)}}" name="prices_old[{{$row->product_id}}]">
                                </td>
                                ...
                                <td class="whole-price-before maybe-hidden "> {{$row->tax}}</td>
                                <td class="whole-price-after maybe-hidden total_pure_enable" width="70">{{round($row->price,3)}}</td>

                                <td class="bill-operations-td maybe-hidden operations_enable" width="160">
                                    <a href="{{route('accounting.products.show',['id'=>$row->product_id])}}" target="_blank" title="عرض المنتح" rel="noopener noreferrer">
