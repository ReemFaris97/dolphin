    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            ...
            <div class="btn-group beside-btn-title">
                <a href="{{route('accounting.safes.create')}}" class="btn btn-success">
                    إضافه خزينة  جديدة
        ...
        <div class="panel-body">
            ...
            {{--@endif--}}
                        ...
                        <td class="text-center">
                            {{--@if($row->type==1)--}}
                            <a href="{{route('accounting.safes.show',$row->id)}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-eye text-inverse" style="margin-left: 10px"></i> </a>

                                {{--@endif--}}
                            <a href="{{route('accounting.safes.edit',$row->id)}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-pencil7 text-inverse" style="margin-left: 10px"></i> </a>
