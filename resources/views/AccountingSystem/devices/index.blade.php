                    ...
                    <tr>
                       ...
                       {!! optional($row->branch)->name!!}
                        ...
                        <td class="text-center">
                            @can('تعديل الجهاز')
                            <a href="{{route('accounting.devices.edit',$row->id)}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-pencil7 text-inverse" style="margin-left: 10px"></i> </a>
                           @endcan
                                @can('حذف الجهاز')
