        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-sm-6 col-xs-6 pull-left">
                    ...
                    {!! Form::select("product_id",$products,null,['class'=>'select2 form-control js-example-basic-single store_id','placeholder'=>' اختر  الصنف'])!!}
                </div>
                ...
                <div class="text-center col-md-12">
                    <div class="text-right">
                        <button type="submit" class="btn btn-success">بحث<i
        ...
        @if (isset($product))
            ...
            <div class="panel-body">
                        ...
                        <td>
                            @if ($product->status==0)
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-id="{{$product->id}}" onclick="openModal({{$product->id}})"
                                        data-target="#exampleModal{{$product->id}}" id="button{{$product->id}}">
                                    ادخل الكميه الفعليه
                                </button>
                            @else
                            ...
                            <div class="modal-content">
                                ...
                                <form id="form{{$product->id}}">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button class="btn btn-primary" id="hamada{{$product->id}}" type="button"
                                                data-dismiss="modal"> اضافةالكميه الفعليه
                                        </button>
                ...
                @isset($inventory)
                    ...
                    <a href="{{route('accounting.stores.inventory_result',$inventory->id)}}"><label
                            class="btn btn-danger">تسوية</label></a>
                @endif
            </div>
        @endif
    </div>
