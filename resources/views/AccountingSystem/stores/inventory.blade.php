        ...
        <div class="panel-body">
                            ...
                            <td>
                                @if ($row->status == 0)
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-id="{{ $row->id }}" onclick="openModal({{ $row->id }})"
                                        data-target="#exampleModal{{ $row->id }}" id="button{{ $row->id }}">
                                        ادخل الكميه الفعليه
                                    </button>
                                @else
                                    ...
                                    <form id="form{{ $row->id }}">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="text" class="form-control" name="Real_quantity"
                                                id="Real_quantity{{ $row->id }}" required>

                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-dismiss="modal">اغلاق</button>
                                            <button class="btn btn-primary" id="real{{ $row->id }}" type="button"
                                                data-dismiss="modal"=""> اضافةالكميه الفعليه</button>
                                        </div>
                                    </form>
                                    {{-- {!!Form::close() !!} --}}
                                </div>
            ...
            @isset($inventory)
                ...
                <div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    aria-hidden="true">
                    <form action="{{ route('accounting.stores.update_cost_type', $inventory->id) }}" method="POST"
                        id="form1">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
