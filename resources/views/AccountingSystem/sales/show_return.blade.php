...
<head>
    ...
    <title> - الفاتورة {{$sale_return->id}}</title>
    <!-- Global stylesheets -->
...
<body>
	...
	<!-- Start Page Content -->
	<!-- ============================================================== -->
	<div class="row printer" id="printer">
		<div class="col-md-12">
			<div class="card">
				<div class="card-body ">
					...
					<div class="container-fluid the-bill-design too-be-topped" id="div-to-print">
						...
						<div class="one-bill-inpt the-bill-date" style="direction: ltr;border-bottom: 0px;display:inline-block;width:50%;text-align: center!important;margin-bottom: 0px;padding-bottom:0px;margin-top: 0px;float:right">
							<span class="bill-lbl"><?php echo $sale_return->date  ?></span>
						...
						<div class="flex-col">
							<table class="tablesaw a-new-table table-hover table table-bordered finalTb" data-tablesaw-mode="stack" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
								<tbody>
								@if(getsetting('daily_number_sales')==1)
									 <tr>
										...
										<td> {!! $sale_return->daily_number !!}</td>
									</tr>
							    	@endif
									<tr>
							...
							<div class="flex-col mar-top-15">
								<table class="tablesaw bill-table-whole-wrapper table-bordered table-hover table finalTb" data-tablesaw-mode="stack" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
