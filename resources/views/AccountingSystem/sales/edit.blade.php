...
<div class="panel panel-flat">
	<div class="panel-heading">
		<h5 class="panel-title">تعديل الفاتورة
...
{{--            @dd(auth()->user()->accounting_store_id)--}}
				...
				<div class="row table-upper-options">
					...
					<div class="form-group block-gp col-md-4 col-sm-4 col-xs-12">
						...
						{!! Form::select("client",$clients,$sale->client_id,['class'=>'selectpicker form-control inline-control','data-live-search'=>'true','id'=>'client_id'])!!}
					</div>
					<div class="form-group block-gp col-md-4 col-sm-4 col-xs-12">
						...
						<tbody>
                            ...
                            <input type="hidden" name="product_id_old[]" value="{{$item->product_id}}">
                                ...
                                <td class="product-quantity maybe-hidden quantity_enable" width="100">
                                    <input type="number" placeholder="الكمية" max="" min="1" value="{{$item->quantity}}" id="sale" class="form-control" name="quantity_old[{{$item->product_id}}]">
                                </td>
						...
						<tfoot>
							<tr>
								...
								<th id="amountOfDariba" class="rel-cols" colspan="3">
									...
									<span class="dynamic-span">{{$sale->totalTaxs}}</span>
									<span class="rs"> ر.س </span>
								</th>
