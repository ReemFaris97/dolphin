...
.a-new-table.tablesaw-sortable td i , .a-new-table.tablesaw-sortable th i {
        position: absolute;
    right: -10px;
    top: 12px;
    color: #2ECC71;
}.a-new-table.tablesaw-sortable td , .a-new-table.tablesaw-sortable th{
        position: relative;
}
...
table.bill-table-whole-wrapper td i , table.bill-table-whole-wrapper th i {
    position: relative;
    right: -6px;
    top: 2px;
    color: #2ECC71;
...
.a-new-table.tablesaw-sortable td:first-child, .a-new-table.tablesaw-sortable th:first-child {
    font-weight: 700;
    font-size: 13px
}
...
.a-new-table.tablesaw-sortable tr:nth-child(2n) , .bill-table-whole-wrapper.tablesaw-sortable tr:nth-child(2n) {
    background: #fff;
}
...
.a-new-table.tablesaw-sortable>tbody>tr>td:first-child, .a-new-table.tablesaw-sortable>tbody>tr>th:first-child {
    position: relative;
        width: 135px;
padding-left: 0
}
.a-new-table.tablesaw-sortable>tbody>tr>td:last-child, .a-new-table.tablesaw-sortable>tbody>tr>th:last-child {
padding-left: 2px;
    padding-right: 2px
}
.a-new-table.tablesaw-sortable>tbody>tr>td:first-child:after, .a-new-table.tablesaw-sortable>tbody>tr>th:first-child:after {
    position: absolute;
    left: 4px;
    top: 2px;
    content: " : ";
    ...
    display: none;
        ...
        @media  print {
            ...
            body thead:first-child{
                display: table-header-group!important; vertical-align: middle; border-color: inherit;
            }
            ...
            .bill-table-tr-wrapper , .fixed-ta-hd , .fixed-ta-hd td {
            ...
            table.bill-table-whole-wrapper th, table.bill-table-whole-wrapper td {
                border:solid #000 !important;
                        ...
                        <div class="card-body ">
                            ...
                            <div class="container-fluid the-bill-design too-be-topped" id="div-to-print">
                                ...
                                <div class="one-bill-inpt the-bill-address" style="display:block;width:100%;text-align: center!important;margin-bottom: 5px">
                                    ...
                                    <span class="bill-lbl">إسم الفرع</span>
                                </div>
                                ...
                                <div class="one-bill-inpt the-cust-name" style="border-bottom: 0px;display:block;width:100%;margin-bottom: 0px;padding-bottom: 0px;border-bottom:1px solid #333!important">
                                    ...
                                    <span style="margin-right:5px;text-align:left;">اسم الكاشير</span>
                                </div>
                                    ...
                                    <div class="flex-col mar-top-15">
                                        <table class="tablesaw bill-table-whole-wrapper table-bordered table-hover table" data-tablesaw-mode="stack" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="big-ser-hed-tit">اسم القسم</span>
                                     ...
                                     10
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="tot-money">250</span></td>
                                            </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <tr>
                                                        <td data-tablesaw-sortable-col data-tablesaw-priority="6" ><i class="ti-bag"></i> كاش</td>
                                                        <td>185</td>
                                                    </tr>
                                                    <tr>
