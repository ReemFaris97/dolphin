                        ...
                        <tab-content title="Personal details" icon="fas fa-archive">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-11">
                                            ...
                                            <v-select name="branch_id" v-model="form.branch_id" :options="branches"
                                                :reduce="branch=>branch.id" @input="(event)=>{getStores();getFaces()}" />
                                        </div>
                                ...
                                <div class="form-group  col-md-6 col-xs-12 ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-11">
                                            <v-select :options="suppliers" v-model="form.suppliers" item-text="name"
                                                item-value="id" multiple :reduce="(supplier)=>supplier.id"
                                                :required="!form.suppliers" {{-- class="form-control" --}}
                                ...
                                <div class="form-group  col-md-6 col-xs-12 ">
                                    ...
                                    <v-select :options="product_type" v-model="form.type"
                                        ...
                                        {{-- class="form-control" --}} placeholder="اختر نوع للمنتج " />
                                </div>
                                ...
                                <div class="form-group  col-md-6 col-xs-12 ">
                                    ...
                                    <v-select :options="units" v-model="form.main_unit"
                                        :reduce="(main_unit)=>main_unit.label" :required="!form.main_unit"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group   col-md-6 col-xs-12 pull-left">
                                        ...
                                        <input type="number" name="purchasing_price" v-model="form.purchasing_price"
                                            class="form-control" />
                                ...
                                <div class="form-group  col-md-12 col-xs-12 ">
                                    ...
                                    <div class="col-md-10">
                                        <v-select name="barcodes[]" v-model="form.bar_code" :taggable="true"
                                            :multiple="true" :options="[]" placeholder="الباركود" />
                                    </div>
                                </div>
                                ...
                                <table class="table  finalTb table-responsive  table-border w-100">
                                    ...
                                    <tbody>
                                        <tr v-for="(sub_unit,index) in  form.sub_units">
                                            <td>
                                                <input type="text" class="form-control" v-model="sub_unit.name">
                                            </td>
                                            <td>

                                                <v-select v-model="sub_unit.bar_code"
                                                    :name="`[sub_units][${index}][bar_code]`" :taggable="true"
                                                    :multiple="true" :options="[]" />
                                            </td>
                                            <td><input type="number" class="form-control"
                                                    v-model="sub_unit.main_unit_present"></td>
                                            <td><input type="number" class="form-control"
                                                    v-model="sub_unit.selling_price"></td>
                                            <td><input type="number" class="form-control"
                                                    v-model="sub_unit.purchasing_price"></td>
                                            <td>
                                                <input type="number" class="form-control" v-model="sub_unit.quantity">
                                            </td>

                                            <td>
                                                <button type="button" class="btn btn-danger" @click="deleteSubUnits(index)">
                                            ...
                                            <tr v-for="(component,index) in  form.components">
                                                <td>
                                                    <v-select label="name" :filterable="false" :options="components"
                                                        v-model="component.name" @search="onSearch">
                                                    </v-select>
                                ...
                                <div v-if="form.type==='offer'">
                                    <div class="form-group col-xs-12 pull-left">
                                        ...
                                        <v-select name="products" label="name" :filterable="false" :options="components"
                                            v-model="form.products" @search="onSearch" multiple id="products"></v-select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <tab-content title="Additional Info">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group   col-md-6  col-xs-12 ">
                                    ...
                                    <v-select name="column_id" v-model="form.column_id" :options="columns"
                                        :reduce="column=>column.id" @input="getCells" />
                            ...
                            <div class="row">
                                <div class="form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left">
                                    <label> الحجم </label><span class="asided-hint"> اختيارى ويكون بالسنتمتر
                                        المكعب</span>
                                ...
                                <div class="form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left">
                                    <label> العرض </label><span class="asided-hint">اختيارى ويكون بالسنتمتر
                                        المربع</span>
                                ...
                                <div class="form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left">
                                    <label> تاريخ الانتهاء </label><span v-if="form.type!=='product_expiration'"
                                        class="asided-hint">اختيارى</span><span v-else class="text-danger">*</span>
                                                ...
                                                <tr v-for="(offer,index) of form.offers">
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-danger" type="button"><i
                                                                class="fas fa-trash"
                                                                @click="(e)=>{form.offers.splice(index,1)}"></i></button>
                                    ...
                                    <div class="row">
                                        <div
                                            ...
                                            <span class="new-radio-wrap">
                                                ...
                                                <input type="radio" v-model="form.tax" :checked="form.tax" name="tax"
                                                    class="form-control" required id="yes1" value="1">
                                            </span>
                                            <span class="new-radio-wrap">
                                                <label for="no1">لايوجد ضريبة</label>
                                                <input type="radio" v-model="form.tax" :checked="form.tax" name="tax"
                                                    class="form-control" id="no1" value="0">
                                            </span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="">
                                                ...
                                                <span class="new-radio-wrap">
                                                    ...
                                                    <input type="radio" name="price_has_tax" required
                                                        class="form-control" value="0" v-model="form.price_has_tax" />
                                                </span>
                                                <span class="new-radio-wrap">
                                                    <label>السعر غير شامل الضريبة </label>
                                                    <input type="radio" name="price_has_tax" required
                                                        class="form-control" value="1" v-model="form.price_has_tax">
                                                </span>
                                            </div>
                                        </div>
                ...
                var app = new Vue({
                    ...
                    methods: {
                        ...
                        deleteSubUnits(index) {
                            axios.delete('/accounting/ajax/products/sub-units/' + this.form.sub_units[index].id).then(
                                function(resp) {
                                    Swal.fire({
                                        title: resp.data.message,
                                        icon: "success"
