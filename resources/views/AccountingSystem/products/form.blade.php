...
<div class="custom-tabs tabs-2020">
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left">
                ...
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal2"
                    style="display: none;" id="components_button">
                    المكونات
                </button>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal3"
                    style="display: none;" id="offers_button">
                    الاصناف التابعة
                </button>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal5"
                    style="display: none;" id="services_button">
                    الخدمات
                </button>
            ...
            <div class="form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left">
                ...
                <button type="button" class="btn btn-primary" id="openExampleModal" data-toggle="modal"
                    data-target="#exampleModal">
                    الوحدات الفرعية
                </button>
                {{-- <input class="form-control autocomplete" placeholder="Enter A" /> --}}
                {!! Form::text('main_unit', null, ['class' => 'form-control autocomplete', 'required', 'placeholder' => ' الوحدة الاساسية ', 'list' => 'unit_names']) !!}

                <datalist id="unit_names">
                        ...
                        <tbody class="add-products">
                            @foreach ($subunits as $unit)
                                <tr>
                                    ...
                                    <td>{{ $unit->quantity }}</td>
                                    <td>
                                        <a href="#" onclick="Delete({{ $unit->id }})"
                                            class="delete-sub-unit">حذف</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="row">
            ...
            <div class="form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left">
                <div class=" form-group">
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary" id="barcodes_button" data-toggle="modal"
                        data-target="#ExampleModalBarcode">
                        اضاقه باركود اخر
                    </button>
    ...
    <div>
        <div class="row">
            ...
            <div class="form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left" id="discounts_button"
                style="display:none">
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal4">العروض
                    والخصومات</button>
            </div>
            <!--discounts table-->
        ...
        <div class="row">
            <div
                ...
                @if (isset($is_edit))
                    ...
                    <span class="new-radio-wrap">
                        ...
                        <input type="radio" name="tax" class="form-control" required id="yes1"
                            value="{{ $has_tax == 1 ? 1 : 0 }}" {{ $has_tax == 1 ? 'checked' : null }}>
                    </span>
                    <span class="new-radio-wrap">
            ...
            @if (isset($price_has_tax))
                @if (isset($has_tax) & ($has_tax == 1))
                    <div id="shamel-mesh">
                        <div
                            class="form-group form-group col-lg-3  col-md-4 col-sm-6 col-xs-12 pull-left form-line new-radio-big-wrapper shamel-mesh">
                            <label>شمول الضريبة</label>
                            <span class="new-radio-wrap">
                                <label> السعر شامل الضريبة </label>
                                <input type="radio" name="price_has_tax" required class="form-control" value="1"
                                    @if ($price_has_tax == 1)  checked @endif /> </span>
                            <span class="new-radio-wrap">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("select[multiple]").each(function() {
                $(this).parent().find("ul.dropdown-menu.inner").children('li:first-child').removeClass(
                    'selected')
