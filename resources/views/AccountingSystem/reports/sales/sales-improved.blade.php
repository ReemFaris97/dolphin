                        ...
                        <div class="col-xs-12">
                            <form action="" method="get" accept-charset="utf-8">
                                <div class="form-group col-sm-3">
                                    ...
                                    {!! Form::select('category_id', \App\Models\AccountingSystem\AccountingProductCategory::pluck('ar_name', 'id'), null, ['class' => 'form-control inline-control', 'id' => 'categories', 'placeholder' => 'اختر']) !!}
                                </div>

                                <div class="form-group col-sm-3">
                                    <label> المنتجات </label>
                                    <select class="form-control selectpicker inline-control" name="product_id"
                                        id="products">
                    ...
                    <tbody>
                        @foreach ($sales as $sale)
                            <tr>
                                ...
                                <td>{{ optional(@$sale->unit)->name ?? optional(@$sale->product)->main_unit }}</td>
                                <td>{{ $sale->quantity }}</td>
                                <td>{{ $sale->price }}</td>
                                <td>{{ $sale->total }}</td>
