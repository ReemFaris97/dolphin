...
@section('title','عرض خطوط الانتاج')
...
@section('content')
    <div class="panel panel-flat">
        <div class="panel-heading">
            <h5 class="panel-title">عرض   خطوط الانتاج
            	<div class="btn-group beside-btn-title">
                <a href="{{route('accounting.productionLines.create')}}" class="btn btn-success">
                   إضافه  خط انتاج  جديد
                ...
                @foreach($lines as $row)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('accounting.productionLines.edit',$row->id)}}"
                            ...
                            {!!Form::open( ['route' => ['accounting.productionLines.destroy',$row->id] ,'id'=>'delete-form'.$row->id, 'method' => 'Delete']) !!}
                            {!!Form::close() !!}
        ...
        function Delete(id) {
            ...
            swal({
                ...
                if(isConfirm){
                    ...
                    swal("تم االإلفاء", "حذف  الخط  تم الغاؤه",'info',{buttons:'موافق'});
                }
            });
        }
    </script>
