...
<div class="form-group col-md-4 pull-left form-line sanad">
...
<div class="form-group col-md-4 pull-left form-line sanads">
	<span class="new-radio-wrap-sanad">
		<label for="client">عميل</label>
	...
	<span class="new-radio-wrap-sanad">
		<label>عام</label>
		<input type="radio" name="concerned" class="styled type" value="general" onclick="myFunction2()" disabled>
	</span>
</div>
@else
<div class="form-group col-md-4 pull-left form-line sanads">
...
@endif
@else
<div class="form-group col-md-4 form-line sanads">
	<span class="new-radio-wrap-sanad">
		<label for="client">عميل</label>
		<input type="radio" name="concerned" class="styled type" onclick="myFunction()" id="client" value="client" checked="checked">
	</span>
	<span class="new-radio-wrap-sanad">
		<label for="supplier">مورد</label>
...
<div class="form-group col-md-4 pull-left">
	<label> العمله </label>
	{!! Form::select("currency",currency(),null,['class'=>'form-control','required'])!!}
</div>
{{-- <div class="form-group col-md-4 pull-left ">
    <label>البيان </label>
    {!! Form::text("description",null,['class'=>'form-control','placeholder'=>' البيان  '])!!}
</div> --}}
<div class="form-group col-md-4 pull-left check">
	<label> رقم الشيك</label>
	{!! Form::text("num",null,['class'=>'form-control','required'])!!}
</div>
<div class="form-group col-md-4 pull-left payments ">
	<label> اختر طريقةالدفع</label>
	{!! Form::select("payment_id",$payments,null,['class'=>'form-control js-example-basic-single','id'=>'payment_id','placeholder'=>' اختر طريقةالدفع ','required'])!!}
</div>
<div class="form-group col-md-4 pull-left revenue_accounts">
...
<div class="form-group col-md-4 pull-left accounts">
...
<div class="form-group col-md-4 pull-left client_accounts">
...
<div class="form-group col-md-4 pull-left supplier_accounts">
...
@endif
<div class="form-group checkbox checkbox-left col-md-4">
	<label for=""></label>
...
<div class="form-group col-md-4 pull-left centers">
