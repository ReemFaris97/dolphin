                ...
                @foreach($titles as $row)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('accounting.jobTitles.edit',$row->id)}}" data-toggle="tooltip" data-original-title="تعديل"> <i class="icon-pencil7 text-inverse" style="margin-left: 10px"></i> </a>
                            @if ($row->active==0)
                            <a href="{{route('accounting.jobTitles.active',$row->id)}}" data-toggle="tooltip" data-original-title="  "> <i class="fa fa-close"></i></a>
                            @else
                            <a href="{{route('accounting.jobTitles.dis_active',$row->id)}}" data-toggle="tooltip" data-original-title="  "> <i class="icon-checkmark-circle" style="margin-left: 10px"></i> </a>
                        @endif
