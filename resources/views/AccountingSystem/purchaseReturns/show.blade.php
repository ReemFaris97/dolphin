...
@section('title','   عرض الفاتوره المرتجعات'.' '. $purchaseReturn->id)
								...
								<table class="tablesaw bill-table-whole-wrapper table-bordered table-hover table" data-tablesaw-mode="stack" data-tablesaw-sortable data-tablesaw-sortable-switch data-tablesaw-minimap data-tablesaw-mode-switch>
									...
									<tbody>
										...
										{{-- <tr>
											...
											<td><span class="tot-money">{!! $purchaseReturn->amount !!}</span></td>
										</tr>
										...
										<tr>
											...
											<td>	{!! $purchaseReturn->totalTaxs !!}</td>
										</tr> --}}

										<tr>
											<td data-tablesaw-sortable-col data-tablesaw-priority="6"><i class="ti-money"></i>   اجمالى  السعر المرتجع</td>
