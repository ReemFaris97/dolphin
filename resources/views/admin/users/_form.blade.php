...
<div class="form-group m-form__group clearfix ">
    ...
    <div class="m-form__group form-group ">
        ...
        <div class="m-checkbox-inline fixed-width-checks">
            <label class="m-checkbox">
                <input class="md-check" id="check-all" name="permissions[]" value="{{$permission->name}}" type="checkbox" @if($user->hasPermissionTo($permission->name)) checked @endif >{{$permission->ar_name}}
                <span></span>
            </label>
        </div>
        @endforeach
        ...
        <div class="m-form__group form-group {{--pos-rel--}}">
            ...
            <div class="m-checkbox-inline">
                <label class="m-checkbox">
                    <input class="md-check" name="permissions[]" value="{{$permission->name}}" type="checkbox">{{$permission->ar_name}}
                    <span></span>
                </label>
            </div>
            @endforeach
