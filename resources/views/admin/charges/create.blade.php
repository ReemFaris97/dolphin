...
@section('title') اضافه عهده
@endsection

@section('header')
@endsection

@section('breadcrumb') @php($breadcrumbs=['العهد'=>route('admin.charges.index'),'اضافه'=>route('admin.charges.create')])
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="m-portlet m-portlet--tab">
                ...
                {!! Form::open(['method'=>'post','route'=>'admin.charges.store','files'=>'true','class'=>'m-form m-form--fit m-form--label-align-right form-relative-white'])!!}
