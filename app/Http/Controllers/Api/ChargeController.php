...
class ChargeController extends Controller
{
    ...
    public function index()
    {
        if (\request("status") == "received") {
            $charges = Charge::whereNull("destroyed_at")
    ...
    public function confirmCharge(Request $request, $id)
    {
        ...
        /** @var Charge $charge */
        $charge = Charge::whereIdAndSupervisorId($id, auth()->user()->id)
    ...
    public function getNotes($id)
    {
        ...
        return $this->apiResponse(
            new NotesResource($this->CollectionPaginate($notes))
        );
    }

    public function getLogs($id)
    {
        $charge = Charge::whereId($id)
            ->where("supervisor_id", auth()->user()->id)
            ->first();
        $logs = $charge->logs;
        return $this->apiResponse(
            new LogsResource($this->CollectionPaginate($logs))
        );
    }
