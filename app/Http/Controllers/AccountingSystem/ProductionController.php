...
class ProductionController extends Controller
{
    ...
    {
        $productions = AccountingProduction::with([
            "company",
            "production_line",
        ])->get();
    ...
    {
        $userPermissionsCompany = AccountingUserPermission::where(
            "model_type",
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            "production_line_id" =>
                "required|numeric|exists:accounting_production_lines,id",
            "products" => "required|array",
            "products.*.product_id" =>
                "required|integer|exists:accounting_products,id",
            "products.*.recipe_id" =>
                "required|integer|exists:accounting_product_recipes,id",
        ...
        DB::commit();
        alert()
            ->success("تم اضافة  امر التصنيع بنجاح !")
            ->autoclose(5000);
    ...
    public function edit($id)
    {
        ...
        $creationProducts = AccountingProductRecipe::with("product")->get();
        return $this->toEdit(
            compact("production", "companies", "creationProducts")
        );
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::commit();
        alert()
            ->success("تم تعديل  أمر التصنيع  بنجاح !")
            ->autoclose(5000);
        return redirect()->route("accounting.productions.index");
    }
