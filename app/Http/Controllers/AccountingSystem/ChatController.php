...
class ChatController extends Controller
{
    ...
    {
        return view("AccountingSystem.chats.index")->with(
            "chats",
            Chat::latest("updated_at")->get()
        );
    }
    ...
    public function update(Request $request, Chat $chat)
    {
        ...
        return \responder::success([
            ...
            "message" => new \App\Http\Resources\Suppliers\MessageResource(
                $message
            ),
        ]);
    }
