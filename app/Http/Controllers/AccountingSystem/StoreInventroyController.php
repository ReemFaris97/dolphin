...
//   dd($product_store);
    ...
    public function inventory_product(){
        ...
        return view('AccountingSystem.stores.inventory_product',compact('stores','products'));
    ...
    public  function inventory_store_product(Request $request)
    {
     ...
     $inputs=$request->all();
        ...
        $stores_quantity=AccountingProductStore::where('product_id',$inputs['product_id'])->sum('quantity');
        if (isset($product)) {
    ...
    public  function invertory_filters_product(){
        ...
        return view('AccountingSystem.stores.invertory_filter_product',compact('stores','inventories'));
    }
    ...
    public  function inventory_filter_product(Request $request)
    {
        ...
        return view('AccountingSystem.stores.invertory_filte_productr',compact('stores','inventories'));
    ...
    public function invertory_details_product($id){
        ...
        $inventory_products=AccountingInventoryProduct::where('inventory_id',$id)->get();
        $inventory= AccountingInventory::find($id);
        return view('AccountingSystem.stores.invertory_details_product',compact('inventory_products','inventory'));
    }
