...
class ProductionLineController extends Controller
{
    ...
    public function store(Request $request)
    {
        $rules = [
            "name" =>
                "required|max:191|unique:accounting_production_lines,name",
            "accounting_company_id" =>
                "required|numeric|exists:accounting_companies,id",
        ];
