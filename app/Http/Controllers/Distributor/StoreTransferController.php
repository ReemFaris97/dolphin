...
class StoreTransferController extends Controller
{
    ...
    {
        $storeTransfers = StoreTransferRequest::withCount("products")
            ->get()
            ->reverse();
    ...
    public function store(Request $request)
    {
        $rules = [
            "sender_id" =>
                "required|numeric|different:distributor_id|exists:users,id",
    ...
    {
        return $this->toShow([
            "store" => StoreTransferRequest::findOrFail($id),
        ]);
    }
