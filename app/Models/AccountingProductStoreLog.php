...
class AccountingProductStoreLog extends Model
{
    ...
    protected static function booted()
    {
        ...
        static::created(function ($log) {
            if ($log->product_store == null) {
                AccountingProductStore::firstOrCreate(
                    [
                        ...
                        "store_id" =>
                            request()->store_id ?? AccountingStore::first()->id,
            ...
            $log->type == "in"
                ? $log->product_store?->increment("quantity", $log->amount)
                : $log->product_store?->decrement("quantity", $log->amount);
        });
    }
    ...
    {
        return $this->belongsTo(
            AccountingProductStore::class,
            "accounting_product_store_id"
        );
    }
    ...
    public function addQuantity(
        ...
        $main_unit_id =
            AccountingProductSubUnit::where("id", $unit_id)->value(
                "main_unit_present"
            ) ?? 1;
