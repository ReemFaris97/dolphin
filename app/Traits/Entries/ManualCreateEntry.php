        ...
        foreach ($creditorAccounts as $creditorAccount) {
            foreach ($debtorAccounts as $debtorAccount) {
                ...
                AccountingAccountLog::create([
                    ...
                    "account_amount_before" =>
                        $last->account_amount_after ??
                        $creditorAccount->account->amount,
