...
trait BillsOperations
{
    public function CreateSupplierBill($request){
        $inputs = $request->except('date','transfer_date','transfer_number','bank_name','check_number','check_date','products','qtys','prices');
        ...
        {
            $billProduct= SupplierBillProduct::create(['product_id'=>$merge['0'],'quantity'=> $merge['1'],'price'=>$merge['2'],'supplier_bill_id'=>$bill->id]);
        }
